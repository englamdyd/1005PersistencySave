package com.example.a503_16.a1005persistencysave;
        ...
        switch(v.getId()){
            ...
            case R.id.resource:
                try(InputStream fis = getResources().openRawResource(R.raw.res);
                    ...
                    //읽은 내용을 저장 할 수 있는 문자열 객체 생성
                    //읽은 내용을 추가 할 수 있도록 하기 위해서 생성
            ...
            case R.id.imagecopy:
                try(InputStream fis = getResources().openRawResource(R.raw.poo2);
                    FileOutputStream fos = openFileOutput("poo2.jpg", Context.MODE_PRIVATE);
                        ){
